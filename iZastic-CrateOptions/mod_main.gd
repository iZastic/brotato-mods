...
const MOD_ID := "iZastic-CrateOptions"
const AUTHORNAME_MODNAME_DIR := MOD_ID # Name of the directory that this file is in
const AUTHORNAME_MODNAME_LOG_NAME := MOD_ID + ":Main" # Full ID of the mod (iZastic-CrateOptions)
...
func install_script_extensions() -> void:
	...
	#ModLoaderMod.install_script_extension("res://mods-unpacked/iZastic-CrateOptions/extensions/main.gd")
	#ModLoaderMod.install_script_extension("res://mods-unpacked/iZastic-CrateOptions/extensions/entities/units/player/player.gd")
